                                        ...
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                {offer.status === 'accepted' && !offer.isExpired ? (
                                                    ...
                                                    >
                                                        <ShoppingCart className="w-4 h-4" /> Lanjut Checkout
                                                    </Link>
                                                ) : offer.status === 'accepted' && offer.isExpired ? (
                                                    ...
                                                    <button 
                                                        disabled 
                                                        className="inline-flex items-center gap-2 mt-4 bg-gray-200 text-gray-500 px-4 py-2 rounded-xl text-sm font-medium cursor-not-allowed"
                                                    >
                                                        Sold/Habis
                                                    </button>
                                                ) : null}
