...
export default function SellerProducts() {
    ...
    const confirmDelete = async () => {
        ...
        try {
            ...
            showToast(deleteType === 'force' ? "Produk dihapus permanen" : "Produk dipindah ke tong sampah", "success");
            fetchProducts(); // Reload data refresh state
        } catch (err) {
            showToast(err.response?.data?.message || "Gagal memproses penghapusan", "error");
        } finally {
    ...
    const handleToggleArchive = async (id) => {
        try {
            ...
            showToast("Status arsip produk diperbarui", "success");
            fetchProducts();
        } catch (err) {
            showToast("Gagal merubah arsip", "error");
        }
    };
    ...
    const handleRestore = async (id) => {
        try {
            ...
            showToast("Produk dipulihkan", "success");
            fetchProducts();
        } catch (err) {
        ...
        <div className="pb-10 max-w-[1200px] mx-auto">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                <div className="flex-1 max-w-md">
                    <SearchFilterBar placeholder="Cari produkmu..." />
                </div>
